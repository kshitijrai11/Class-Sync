...
public class Student {
    ...
    public String toString() {
        return " District =" + nameOfDistrict + ", Block=" + block + ", Center Number=" + centreNumber + ", Center Name=" + centreName + ", Roll Number =" + rollNo + ", Student Name= " + studentName + ", Mother Name=" + motherName + ", Father Name=" + fatherName + ", Gender" + gender + ", DOB = " + dateOfBirth + ", Category = " + category + ", Aadhar = " + aadharNumber + ", Mobile Number= " + mobileNumber + ", School = " + schoolName + ", UDISE=" + udise + ", Class Name=" + className + ", subject=" + subject + ", Sub date=" + subDate + ", Sub time = " + subTime + ", Barcode = " + barcode;
    }
